...
class MyClass:
    def __init__(self):
        ...
        self.headers={
            ...
            'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
            'Referer': 'https://ilogistics.aliexpress.com/recommendation_engine_internal.htm?spm=5261.order_list.aenewaside.10.41c53e5fnZ5gvK',
            'Cookie': 'ali_apache_id=10.103.166.15.1564575673547.177615.0; cna=unXIFU8aEwoCAXxA0zQnct2B; aep_common_f=v3qGXOp1GoXMhA/2VVDvFJf2Z4oEFQrkeqQ90IZZIk2dxi1BCQ16Yw==; _ga=GA1.2.1460708672.1564575686; _lang=zh_CN; _fbp=fb.1.1564581537949.1289620551; ali_beacon_id=10.103.166.15.1564575673547.177615.0; UM_distinctid=16c6697c305357-04289e78a2e922-3a65460c-384000-16c6697c30e28e; aep_history=keywords%5E%0Akeywords%09%0A%0Aproduct_selloffer%5E%0Aproduct_selloffer%094000029219793%094000029579588%094000043032234%094000069147733%094000064789395%094000065883456%094000069147733%094000065883456; acs_usuc_t=x_csrf=k6h2p4ioolx4&acs_rt=180a3ee5d02d465a853b61637db24802; _m_h5_tk=ec20ce5983aec8a66fd3b4e3eb5a63f8_1565192734174; _m_h5_tk_enc=2a4e6b80e9d6bb8acc2f209ad328986f; _hvn_login=13; xman_us_t=x_lid=cn1528697535hccf&sign=y&x_user=Nh7lcNFGC+hWcg0d4IBd/Qx8GVTfQQhSwPluAeyqABg=&ctoken=q6rjf6_m76yf&need_popup=y&l_source=aliexpress; aep_usuc_t=ber_l=A0; xman_f=; ali_apache_tracktmp=W_signed=Y; intl_locale=zh_CN; JSESSIONID=149908C912F73CC873BA146B31094021; ali_apache_track=mt=2|ms=|mid=cn1528697535hccf; xman_us_f=x_l=1&x_locale=zh_CN&no_popup_today=n&x_user=CN|Ying|Xia|cnfm|238871718&zero_order=y&last_popup_time=1564575687325; aep_usuc_f=site=glo&region=CN&b_locale=en_US&iss=y&s_locale=zh_CN&isfm=y&c_tp=USD&x_alimid=238871718; intl_common_forever=WIq/CSTKXJ+s7ipUKtEFH+CRwhr/wuA9xZaBuPYEoKP0g7swGFDF/g==; l=cBSQzz7gqbbLJ__kBOfaNuI8LI_TzndXhsPzw4OMnICPOh6y-q85WZFNfwK2CnGVLsdkR3lcLzQLBjYSGy4EiqyF2lig4Qdd.; isg=BL29U5AjvJaIDxjxaAXnailvzBl38vC8hRM2G38TJZR0ttboR659fewuYKpVNglk; xman_t=',
        }
    ...
    def get_countries(self, continent):
        ...
        with open(f'depend/{continent}.txt', encoding='utf-8') as f:
            for line in f:
                # print(line.split(' ')[0])
                conti_list.append(line.split(' ')[0])
...
for c in continents:
    ...
    result.to_excel(f'{c}.xlsx', index=0)
